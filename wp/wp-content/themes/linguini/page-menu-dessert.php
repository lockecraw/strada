<?php
/*
Template Name: Page: Foods - Dessert
*/
?>
<?php get_header(); ?>
                    ...
                    <div class="page-left-container">
                    	...
                    	<div class="rail-left sidebar left">
                            ...
                            <nav class="navigation-menucard">
                                <ul>
                                    <?php
                                    $taxonomy = 'menu-dessert-categories';
                                                ...
                                                ?>
                                                        ...
                                                        <article id="post-<?php the_ID(); ?>" class="post left <?php if(has_post_thumbnail()) { ?>with-image<?php } ?>">
                                                            ...
                                                            <div class="post-image image-overlay image shadow left">
                                                                ...
                                                                ?>
                                                                <?php if (get_option('gp_menu_dessert_link_image') != 'No') { ?>
                                                            ...
                                                            <div class="post-content right">
                                                                ...
                                                                <header class="post-header">
                                                                    <h3 class="left">
                                                                    <?php the_title(); ?>
                                                                        <?php if (get_post_meta($post->ID, 'gp_menu_dessert_price', true)) { ?>
                                                                            <span class="post-price right"><?php echo stripslashes(get_post_meta($post->ID, 'gp_menu_dessert_price', true)); ?></span>
                                                                        <?php } ?>
                                                                        
                                                                    </h3>
                                                                </header><!-- post-header -->
                                                                
                                                                <?php if (get_post_meta($post->ID, 'gp_menu_dessert_description', true)) { ?>
                                                                <p class="post-description left">
                                                                    <?php echo stripslashes(get_post_meta($post->ID, 'gp_menu_dessert_description', true)); ?>
                                                                </p><!-- post-description -->
                                                                <?php } ?>
